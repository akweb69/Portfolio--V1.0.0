...
function MenuBar(): React.JSX.Element {
  return (
    <motion.nav
      className="p-2 rounded-full bg-teal-100 backdrop-blur-lg border border-gray-200/80 dark:border-gray-800/80 shadow-lg dark:shadow-gray-900/20 relative overflow-hidden"
      initial="initial"
      whileHover="hover"
    >
      <motion.div
