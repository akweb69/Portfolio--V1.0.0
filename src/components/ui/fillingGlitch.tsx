    ...
    <div className="relative w-full h-screen overflow-hidden">
      ...
      <FallingGlitch>
        <div className="text-center">
          <h1
            className="text-8xl md:text-[200px] lg:text-[240px] font-extrabold text-white"
            style={{ fontFamily: "'Dancing Script', cursive" }}
          >
            Abu Kalam
          </h1>
          <div className="bg-teal-700 w-fit mx-auto rounded-full absolute bottom-16 p-2 right-1/2 left-1/2 -translate-x-1/2">
